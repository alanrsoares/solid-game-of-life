...
const Button: Component<Props> = ({ variant, ...props }) => {
  return (
    <button
      role="button"
      className="rounded-full text-white h-16 w-16 p-4 grid place-items-center hover:opacity-75 focus:(outline-none ring ring-offset-gray-800 ring-offset-2) disabled:(opacity-50 filter grayscale cursor-not-allowed)"
      classList={{
